...
namespace Lunarlight.Hovercraft.V3
{
    ...
    public sealed class V3GimbalController : MonoBehaviour
    {
        ...
        private readonly List<V3GimbalFirmwareRuntime> firmware =
            new List<V3GimbalFirmwareRuntime>(2);
            ...
            V3PowerDistributor powerDistributor)
        {
            ...
            for (int i = 0; i < runtime.InstalledParts.Count; i++)
            {
                ...
                {
                    gimbals.Add(gimbal);
                    firmware.Add(new V3GimbalFirmwareRuntime(gimbal));
                }
            }
        }
        ...
        public void SetFirmwareSystemsGrantFraction(float fraction)
        {
            ...
            {
                firmware[i].SetSystemsGrantFraction(fraction);
            }
        }
