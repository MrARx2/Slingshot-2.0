...
namespace Lunarlight.Hovercraft.V3
{
    ...
    public sealed class ThrusterDefinition : EndpointDefinition
    {
        ...
        public float NominalForwardForceN => maximumForwardForceN;
        public float MaximumNormalForceN =>
            maximumForwardForceN * NormalOutputMultiplier;
        public float MaximumEmergencyForceN =>
            maximumForwardForceN * OverloadOutputMultiplier;
