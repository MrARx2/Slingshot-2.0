...
namespace Lunarlight.Hovercraft.V3
{
    ...
    public class RuntimePartInstance : MonoBehaviour
    {
        ...
        public float CurrentAmbientTemperatureC { get; private set; }
        public float EnvironmentalCoolingMultiplier { get; private set; } = 1f;
        public float RelativeCoolingAirspeed { get; private set; }
        ...
        public virtual void Initialize(PartDefinition definition, string parentSocketId)
        {
            ...
            CurrentTemperatureC = definition != null && definition.Thermal.enabled
                ...
                : 0f;
            CurrentAmbientTemperatureC = CurrentTemperatureC;
            EnvironmentalCoolingMultiplier = 1f;
            RelativeCoolingAirspeed = 0f;
        ...
        public void TickThermal(
            float deltaTime,
            V3ThermalEnvironmentInput environment)
        {
            ...
            ThermalProfile thermal = Definition.Thermal;
            CurrentAmbientTemperatureC = environment.AmbientTemperatureC;
            EnvironmentalCoolingMultiplier =
                environment.EffectiveCoolingMultiplier;
            RelativeCoolingAirspeed = environment.RelativeAirspeed;
        ...
        public void ApplyActiveCooling(
            float heatRemovalPerSecond,
            float deltaTime)
        {
            if (Definition == null ||
                !Definition.Thermal.enabled ||
                heatRemovalPerSecond <= 0f ||
                deltaTime <= 0f)
            {
                return;
            }
        ...
        public static float CalculatePassiveCoolingPerSecond(
            ...
            float temperatureC)
        {
            return CalculatePassiveCoolingPerSecond(
                thermal,
                temperatureC,
                thermal.ambientTemperatureC,
                1f);
