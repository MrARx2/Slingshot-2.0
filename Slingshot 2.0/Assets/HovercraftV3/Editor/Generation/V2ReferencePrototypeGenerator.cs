...
namespace Lunarlight.Hovercraft.V3.Editor
{
    ...
    {
        public const string PrototypeRoot =
        ...
        public static void Generate()
        {
            ...
            V3HoverConfigurationAssetUtility.Configure(
                reference, "hover.apex.reference.01", 3.075f, 0.5f, 7f);
            ...
            ConfigureBuildIdentity(
                gimbalBuild,
                "build.apex.v3.main_gimbal_demo.01",
                "Apex V3 Vector",
            ...
            V3HoverConfigurationAssetUtility.Configure(
                gimbalBuild, "hover.apex.vector.01", 3.075f, 0.5f, 7f);
            ...
            ConfigureBuildIdentity(
                springBuild,
                "build.apex.v3.hover_spring_demo.01",
                "Apex V3 Terrain",
            ...
            V3HoverConfigurationAssetUtility.Configure(
                springBuild, "hover.apex.terrain.01", 3.075f, 0.5f, 7f);
            ...
            string drivingNotes)
        {
            var serialized = new SerializedObject(build);
            serialized.FindProperty("stableId").stringValue = stableId;
            serialized.FindProperty("ownership").enumValueIndex =
                (int)V3BuildOwnership.GeneratedReference;
            serialized.FindProperty("allowLegacyPipelineFallback").boolValue = true;
            serialized.FindProperty("buildAssetGuid").stringValue =
                AssetDatabase.AssetPathToGUID(AssetDatabase.GetAssetPath(build));
            serialized.FindProperty("displayName").stringValue = displayName;
